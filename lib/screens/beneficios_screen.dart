...
import 'package:universal_html/html.dart' as html; // Abrir Archivos
...
class _BeneficiosScreenState extends State<BeneficiosScreen> {
  ...
  // Guardamos los bytes del archivo localmente (para visualización web)
  ...
  Future<void> _abrirArchivo(int id, String nombre) async {
    final bytes = _archivosGuardados[id];
    if (bytes == null) {
      NotificationBanner.show(
        context,
        "⚠️ Este archivo no se encuentra disponible.",
        NotificationType.error,
      );
      return;
    }
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          // 🔽 ComboBox con tipos oficiales de Nutri Leche Ecuador
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _nombreArchivo ?? "Seleccionar archivo",
                      style: TextStyle(
